...
const getProfile = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getProfileRequest()) }
...
const updateProfile = (data) => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.updateProfileRequest()) }
        async function onSuccess(response) {
        ...
        onRequest();
        APIService.request({
            method: 'put', url: '/me', data: data.user
        }).then(onSuccess).catch(onError);
    })
}
...
const getAllergies = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getAllergiesRequest()) }
        async function onSuccess(response) {
...
const updateMyOtherAllergies = (data) => (dispatch) => {
    return (
        dispatch(accountActions.updateMyOtherAllergies(data))
    )
}
...
const updateMyAllergies = (data) => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.updateMyAllergiesRequest()) }
        async function onSuccess(response) {
        ...
        onRequest();
        APIService.request({
            method: 'put', url: '/allergies/my', data: data
        }).then(onSuccess).catch(onError);
    })
}
...
const getMyAllergies = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getMyAllergiesRequest()) }
        async function onSuccess(response) {
...
const getRestrictions = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getRestrictionsRequest()) }
        async function onSuccess(response) {
...
const updateMyRestrictions = (data) => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.updateMyRestrictionsRequest()) }
        async function onSuccess(response) {
...
const getMyRestrictions = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getMyRestrictionsRequest()) }
        async function onSuccess(response) {
...
const getFitnessGoals = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getFitnessGoalsRequest()) }
        async function onSuccess(response) {
...
const updateFitnessGoal = (data) => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.updateFitnessGoalsRequest()) }
        async function onSuccess(response) {
...
const addDeliveryAddress = (data) => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.addDeliveryAddressRequest()) }
        async function onSuccess(response) {
        ...
        onRequest();
        APIService.request({
            method: 'post', url: '/dropoffs', data: data
        }).then(onSuccess).catch(onError);
    })
}
...
const getDeliveryAddress = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getDeliveryAddressRequest()) }
        async function onSuccess(response) {
...
const setDefaultLocationToUser = (location, token) => () => {
    return new Promise((resolve, reject) => {
        ...
        APIService.request({
            method: 'put', url: '/users/defaultSetting', data: location
        }).then(onSuccess).catch(onError);
    })
...
const addPaymentMethod = (data) => (dispatch) => { //card token id in data
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.addPaymentMethodRequest()) }
        async function onSuccess(response) {
            dispatch(snackbarActions.showSnackbar({ message: response.message, type: "success" }))
        ...
        onRequest();
        APIService.request({
            method: 'post', url: '/payment-methods', data: data
        }).then(onSuccess).catch(onError);
    })
}
...
const getPaymentMethods = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getPaymentMethodsRequest()) }
        async function onSuccess(response) {
...
const setDefaultPaymentMethod = (data) => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.setDefaultPaymentMethodRequest()) }
        async function onSuccess(response) {
            dispatch(snackbarActions.showSnackbar({ message: response.message, type: "success" }))
        ...
        onRequest();
        APIService.request({
            method: 'put', url: '/payment-methods/default', data: data
        }).then(onSuccess).catch(onError);
    })
...
const getSubscriptions = () => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.getSubscriptionsRequest()) }
        async function onSuccess(response) {
...
const updateSubscription = (data) => (dispatch) => {
    return new Promise((resolve, reject) => {
        async function onRequest() { dispatch(accountActions.updateSubscriptionRequest()) }
        async function onSuccess(response) {
        ...
        onRequest();
        APIService.request({
            method: 'put', url: '/purchaseSubscription', data: data   //here data replace with subscription id
        }).then(onSuccess).catch(onError);
    })
}
