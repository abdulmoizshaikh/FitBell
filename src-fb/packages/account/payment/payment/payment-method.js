        ...
        return (
            <Container>
                <HeaderComponent
                    headerLeft={
                        <TouchableWithoutFeedback
                            onPress={() => params.fromComponent ? this.props.navigation.goBack() : this.props.navigation.dispatch(DrawerActions.openDrawer())}>
                            <Icon name={params.fromComponent ? "ios-arrow-back" : "align-left"}
                                type={params.fromComponent ? "Ionicons" : "Feather"}
                                style={[commonStyles.headerIconColor, commonStyles.padding10]} />
                        </TouchableWithoutFeedback>
                    }
                    headerBody={(<Title style={commonStyles.headerIconColor}>Payment Info</Title>)}
                    headerRight={
                        <TouchableWithoutFeedback
                            onPress={() => this.openStripeCard()}
                        >
                ...
                {paymentMethods.length === 0 ?
                    ...
                    <PaymentWithoutMethod
                        openStripe={this.openStripeCard} /> :
