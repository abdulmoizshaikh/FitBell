...
import { ScrollView, AsyncStorage, TouchableOpacity, TouchableWithoutFeedback } from "react-native";
import { Text, Container, View, Item, Input, Button, Spinner, Icon, H1, Label, Form } from 'native-base'
import { StackActions, NavigationActions } from "react-navigation";
import styles from '../styles/inputFormStyle.js';


// packages
import { loginFromValidatorsOnChange, loginFromValidatorsOnBlur } from "./validator";
            ...
            <Container>
                ...
                >
                    ...
                    <Form style={styles.formWrapper}>
                        <Item error={this.state.errorsMsgs.email !== ""} stackedLabel style={styles.item}>
                        ...
                        <Item error={this.state.errorsMsgs.password !== ""} stackedLabel style={[styles.item]}>
                        ...
                        <Text
                            ...
                            onPress={() => this.props.navigation.navigate('ForgotPass', { translateX: true })}>
                            Forgot Password
                            </Text>
                        ...
                        >
                            {this.props.isFetching ? <Spinner color="#fff" /> : <Text uppercase={false} style={{fontSize: 17, fontWeight: '600' }}>Sign In</Text>}
                        </Button>
                    ...
                    <View style={styles.fbBtnAndTextWrapper}>
                        <View style={styles.hrlineView}>
                            ...
                            <Text info style={styles.loginButtonBelowText1}>OR CONNECT WITH</Text>
                            <View style={styles.hairline} />
                        </View>
                        ...
                        <View style={styles.footerWrapper}>
                            <Text info style={styles.footerText}>Don't have an account yet?</Text>
