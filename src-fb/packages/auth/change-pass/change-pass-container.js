...
import { Text, Container, Item, Input, Button, H2, Icon, Spinner, Label } from 'native-base';
                    ...
                    <View style={styles.contentWrapper}>
                        ...
                        <Item style={styles.item} stackedLabel>
                            ...
                            <Input
                                ...
                                onChangeText={(text) => { this.onChangeHandler(text, "confirmPassword") }}
                                ref={inputRef => this.inputs['confirmPassword'] = inputRef}
                            />
                        </Item>
                        <Button primary block
                            style={styles.submitBtn}
                            disabled={!isValid(this.state.errors, this.state) || !(this.state.password === this.state.confirmPassword)}
                            onPress={this.onSubmitHandler}>
                            {this.props.isFetching ? <Spinner color="#fff" /> : <Text uppercase={false}>Reset</Text>}
                        </Button>
                    </View>
                </View>
