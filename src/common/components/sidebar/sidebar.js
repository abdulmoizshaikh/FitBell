...
import { ScrollView, TouchableWithoutFeedback, TouchableOpacity } from "react-native";
import { Text, Container, List, ListItem, Left, Right, View, Thumbnail, Icon } from "native-base";
    ...
    */}
    if (data.home) {
      ...
      return (
        <View style={styles.listItemsContainer}>
          <View style={styles.listItemsIconContainer}>
            <Icon name="restaurant" type="MaterialIcons" style={styles.listItemsIcon} />
          </View>
          <Text>{data.name}</Text>
        </View>);
    }
      ...
      return (
        <View style={styles.listItemsContainer}>
          <View style={styles.listItemsIconContainer}>
            <Icon name="notifications" type="MaterialIcons" style={styles.listItemsIcon} />
          </View>
          <Text>{data.name}</Text>
        </View>);
    }
      ...
      return (
        <View style={styles.listItemsContainer}>
          <View style={styles.listItemsIconContainer}>
            <Icon name="favorite" type="MaterialIcons" style={styles.listItemsIcon} />
          </View>
          <Text>{data.name}</Text>
        </View>);
    }
      ...
      return (
        <View style={styles.listItemsContainer}>
          <View style={styles.listItemsIconContainer}>
            <Icon name="credit-card-alt" type="FontAwesome" style={styles.listItemCreditIcon} />
          </View>
          <Text>{data.name}</Text>
        </View>);
    }
      ...
      return (
        <View style={styles.listItemsContainer}>
          <View style={styles.listItemsIconContainer}>
            <Icon name="settings" type="MaterialIcons" style={styles.listItemsIcon} />
          </View>
          <Text>{data.name}</Text>
        </View>);
    }
      ...
      return (
        <View style={styles.listItemsContainer}>
          <View style={styles.listItemsIconContainer}>
            <Icon name="contacts" type="MaterialCommunityIcons" style={styles.listItemsIcon} />
          </View>
          <Text>{data.name}</Text>
        </View>);
    }
            ...
            <View style={styles.sidemenuTitleSectionWrapper}>
              <View style={styles.sidemenuTitleSectionContent} >
                <View style={styles.headerThumbnailWrapper}>
                  <Thumbnail large source={myimage} style={styles.headerThumbnail1} />
                </View>
                <View style={styles.sidemenuTitleRightSection}>
                  <Text style={styles.userName}>{this.props.user.name}</Text>
                  <View
                    style={styles.ketoAndEditIconWrapper}>
              ...
              <View style={styles.sidemenuDetaisSection}>
                ...
                <View
                  ...
                  <Thumbnail small source={myimage} style={styles.headerThumbnail2} />
                ...
                <View
                  style={{ flex: 1, alignItems: 'center' }}>
                  <Icon name="diamond" type="SimpleLineIcons" style={styles.headerIcons} />
                  <View style={styles.IconDescriptionContainer}>
