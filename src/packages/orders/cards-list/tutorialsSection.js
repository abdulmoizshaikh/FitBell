        ...
        return (
            <Container style={[{ marginTop: 10, height: 293}]}>
                <View style={[styles.backgroundImage]}>
                    <TouchableOpacity style={StyleCloseBtn.tutorilasCloseBtnWrapper} 
                ...
                <View style={{  borderBottomWidth: 1, borderBottomColor: '#c7c7cc',}}>
                    {{
                        0: <View style={{ alignItems: 'center' }}>
                            <Text dark>
                                Discover good meals that fits your goal!
                                </Text>
                        </View>,
                        1: <View style={{ alignItems: 'center', marginTop: 10, marginBottom: 20}}>
                            <VideoTutorials/>
                            <Text dark style={{ fontSize: 24, fontWeight: 'bold' }}> Quick Tutorials </Text>
                            <Text info style={[]}> Get started and learn about fitbowl. </Text>
                        </View>,
                        2: <View style={{ alignItems: 'center' }}>
                            <Text dark>
