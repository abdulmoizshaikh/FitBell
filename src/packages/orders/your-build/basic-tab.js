        ...
        return (
            <Container>
                ...
                <HeaderComponent
                    ...
                    headerBody={(<Title style={commonStyles.headerIconColor}>Your Build</Title>)}
                />

                <Tabs tabContainerStyle={{ elevation: 0 }}
                    tabBarUnderlineStyle={{ borderBottomColor: 'green', borderBottomWidth: 1 }}>
                    <Tab activeTextStyle={{ color: 'green', fontWeight: 'normal' }}
                    ...
                    <Tab activeTextStyle={{ color: 'green' }}
                        activeTabStyle={{ backgroundColor: "#FFF" }}
                        textStyle={{ color: "#000" }}
                        tabStyle={{ backgroundColor: '#FFF' }}
                        heading="Past">
