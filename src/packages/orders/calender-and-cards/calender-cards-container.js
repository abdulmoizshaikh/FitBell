...
class CalenderCardContainer extends Component {
  ...
  render() {
    ...
    const myMarkedDatesOnly = myOrdersData.map(order =>
    ...
    if (selectedDate) {
      myMarkedDatesObject[selectedDate] = {
        ...myMarkedDatesObject[selectedDate],
        selected: true,
      };
    }
          ...
          headerRight={
            <View style={styles.headerRightView}>
              <Icon
                name="grid"
                type="Feather"
                style={styles.headerGridIconStyle}
                  ...
                  <View
                    ...
                    <FlatList
                      ...
                      renderItem={({item}) => {
                        ...
                        let orderCreater = '';
                        if (order.user._id === item.created_by) {
                          orderCreater = 'You';
                        } else if (order.user._id === undefined) {
                          orderCreater = '';
                        } else {
                          orderCreater = item.trainer.name;
                        }
