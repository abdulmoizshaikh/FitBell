        ...
        <HeaderComponent
          headerLeft={
            this.state.editableMode ? (
              <Button
                ...
                <Icon
                  name="ios-arrow-back"
                  style={commonStyles.headerIconColor}
                />
              </Button>
            ) : (
              <Button
          ...
          headerBody={
            <Title style={commonStyles.headerIconColor}>
              {this.state.editableMode ? 'Edit Profile' : 'Profile'}
            </Title>
          }
          headerRight={
            this.state.editableMode ? (
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Item style={{flex: 0.8}}>
                <DatePicker
                  ...
                  onDateChange={date =>
                    this.setDateAndFocusNextField(date, 'newPassword')
                  }
                  disabled={this.state.editableText}
                />
              </Item>
