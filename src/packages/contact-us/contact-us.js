...
import { View, Text, Container, Icon, Title, ListItem, Left, Body, Right, Button } from "native-base";
        ...
        return (
            <Container>
                <HeaderComponent
                    ...
                    headerBody={(<Title style={commonStyles.headerIconColor}>Contacts</Title>)}
                    headerRight={
                        <TouchableWithoutFeedback>
                            <Text primary style={[commonStyles.padding10]}>Feedback</Text>
                        </TouchableWithoutFeedback>}
                />
                ...
                <View>
                    ...
                    <ListItem style={styles.listItem}>
                        ...
                        <TouchableOpacity style={styles.rightTextWrapper}
                    ...
                    <ListItem style={styles.listItem}>
                        <View style={styles.leftIconWrapper}>
                            <Icon name="globe" type="SimpleLineIcons" style={styles.iconStyle} />
                        </View>
                        <Body style={styles.bodyTextWrapper}>
                ...
                <View style={styles.fbTwitterBtnsWrapper}>
                    <Button
                        iconRight block bordered
                        style={styles.btnStyle}
                        onPress={() => Linking.openURL("https://www.facebook.com/")}>
                        <Text uppercase={false} style={styles.btnTextStyle} >Facebook</Text>
                    ...
                    <Button
                        ...
                        <Text uppercase={false} style={styles.btnTextStyle} >Twitter</Text>
                        <Icon name="twitter" type='FontAwesome' style={styles.btnIconColor} />
                    </Button>
                </View>
