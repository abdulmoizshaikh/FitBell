    ...
    return (
      <Container>
        <HeaderComponent
          ...
          headerBody={
            <Title style={commonStyles.headerIconColor}>GIVE 3 + GET 3</Title>
          }
        />
        ...
        <ScrollView
          ...
          <Text style={styles.titleStyle}>
            Add the sweet touch to your friends day. Invite your friends to
            download our app, and they'll each get $3 in credit to send ad
            FitBowl. Once they spend their $3 too!
          </Text>

          <Button rounded bordered dark block style={styles.btnStyle}>
            <Text>SHARE</Text>
          </Button>
