...
import { View, FlatList, AsyncStorage, TouchableWithoutFeedback } from 'react-native';
...
class ProductsMenuContainer extends Component {
    ...
    render() {
        ...
        if (params) { addMealIcon = params.addMealIcon }
        else { addMealIcon = false }
            ...
            <Container>
                ...
                {(params) ?
                    <HeaderComponent
                        ...
                        headerBody={(<Title style={commonStyles.headerIconColor}>Menu</Title>)}
                        headerRight={<Icon name="ios-search" type="Ionicons" style={commonStyles.padding10} />}
                    /> :
                    <HeaderComponent
                        headerLeft={
                            <TouchableWithoutFeedback
...
export default connect(mapStateToProps, mapDispatchToProps)(ProductsMenuContainer);
