...
const getExploreProducts = () => dispatch => {
  return new Promise((resolve, reject) => {
    async function onRequest() {
      dispatch(productActions.getExploreProductsRequest());
    }
...
const getExploreProductDetails = itemId => dispatch => {
  return new Promise((resolve, reject) => {
    async function onRequest() {
      dispatch(productActions.getExploreProductDetailsRequest());
    }
    async function onSuccess(response) {
...
const getFavouriteProducts = () => dispatch => {
  return new Promise((resolve, reject) => {
    async function onRequest() {
      dispatch(productActions.getFavouriteProductsRequest());
    }
    async function onSuccess(response) {
...
const addFavouriteProducts = data => dispatch => {
  return new Promise((resolve, reject) => {
    async function onRequest() {
      dispatch(productActions.addFavouriteProductsRequest());
    }
    async function onSuccess(response) {
    ...
    APIService.request({
      method: 'post',
      url: '/products/favorite',
      data: {product_id: data.product._id},
    })
      .then(onSuccess)
      .catch(onError);
  });
